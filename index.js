...
async function connectToWA() {
    ...
    conn.ev.on('connection.update', (update) => {
        ...
        if (connection === 'close') {
            ...
            let up = `*Hey I'M Online Now*\n_Type .menu to get all bot commands_ ⤵\n\nᴹᵃᵈᵉ ᴮʸ ᴹʳᴰⁱˡᵃ`;
    ...
    conn.ev.on('messages.upsert', async (mek) => {
        ...
        if (isStatusReply) {
            ...
            const originalStatus = await getOriginalStatus();  // This function is defined below
        ...
        const isMe = botNumber.includes(sender.split('@')[0]);
        const isOwner = ownerNumber.includes(sender.split('@')[0]) || isMe;
